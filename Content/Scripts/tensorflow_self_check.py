...
- Could not load 'nvcuda.dll'. The GPU version of TensorFlow requires that
	...
	cudnn7_found = False
	try:
		cudnn7_found = ctypes.WinDLL("cudnn64_7.dll")
		cudnn5_found = True
	except OSError:
		candidate_explanation = True

	if (not cudnn5_found or 
		not cudnn6_found or
		not cudnn7_found):
		print()
	...
	* TensorFlow 1.5 or later requires cuDNN 7. ('cudnn64_7.dll')
		
	You may install the necessary DLL by downloading cuDNN from this URL:
	https://developer.nvidia.com/cudnn""")
	
	print(candidate_explanation)
